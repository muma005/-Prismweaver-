...
```bash
git clone https://github.com/<your-username>/prismweaver-backend.git
git clone https://github.com/<your-username>/prismweaver-frontend.git
```

### **2. Set Up Backend**
1. Navigate to the backend directory:
   ```bash
   cd prismweaver-backend
   ```
